...
- **connections/** — Open Autonomy framework connections (`kv_store` for persistent state, `genai` for LLM calls, `x402`, plus the standard `abci`, `http_client`, `http_server`, `ipfs`, `ledger`, `p2p_libp2p_client`).
