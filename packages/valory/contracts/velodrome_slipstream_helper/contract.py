...
class VelodromeSlipstreamHelperContract(Contract):
    """The Velodrome Slipstream Helper contract."""

    contract_id = PublicId.from_str("valory/velodrome_slipstream_helper:0.1.0")
