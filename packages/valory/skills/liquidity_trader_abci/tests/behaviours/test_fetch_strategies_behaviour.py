...
class TestFetchStrategiesBehaviour(LiquidityTraderAbciFSMBehaviourBaseCase):
    ...
    def mock_track_eth_transfers_and_reversions_zero_reversion(self, safe_address, chain):
    ...
    def mock_update_portfolio_metrics(self, total_user_share_value_usd, individual_shares, portfolio_breakdown, allocations):
        yield
        pass
    ...
    @pytest.mark.parametrize("address_info,expected_result,test_description", [
        ({"name": "GnosisSafeProxy", "is_contract": True}, True, "gnosis safe contract"),
        ({"name": "Regular Wallet", "is_contract": False}, False, "regular wallet"),
    ])
    def test_is_gnosis_safe_variations(self, address_info, expected_result, test_description):
    ...
    @pytest.mark.parametrize("from_address,expected_result,test_description", [
        ({"name": "Regular Wallet", "is_contract": False, "hash": "0x1234567890abcdef"}, True, "regular wallet"),
        ({"name": "Gnosis Safe", "is_contract": True, "hash": "0x1234567890abcdef"}, False, "gnosis safe"),
    ])
    def test_should_include_transfer_variations(self, from_address, expected_result, test_description):
    ...
    @pytest.mark.parametrize("timestamp,expected_result,test_description", [
        ("2025-01-01T12:00:00", "valid", "valid timestamp"),
        ("invalid_timestamp", None, "invalid timestamp"),
    ])
    def test_get_datetime_from_timestamp_variations(self, timestamp, expected_result, test_description):
    ...
    def test_get_historical_price_for_date_success(self):
        ...
        with patch.multiple(
            ...
            result = self._consume_generator(fetch_behaviour._get_historical_price_for_date(
    ...
    @pytest.mark.parametrize("api_response,expected_result,test_description", [
        (
    ...
    def test_fetch_historical_eth_price_variations(self, api_response, expected_result, test_description):
        ...
        with patch.object(fetch_behaviour, '_request_with_retries', mock_request_with_retries):
            result = self._consume_generator(fetch_behaviour._fetch_historical_eth_price("01-01-2024"))
            assert result == expected_result, f"Failed for {test_description}"

    @pytest.mark.parametrize("symbol,chain,expected_result,test_description", [
        ("usdc", "mode", "valid", "known token symbol"),
        ("unknown_token", "mode", None, "unknown token symbol"),
    ])
    def test_get_coin_id_from_symbol_variations(self, symbol, chain, expected_result, test_description):
    ...
    def test_should_recalculate_portfolio_true(self):
        ...
        with patch.object(
            ...
            with patch.object(fetch_behaviour, "_load_chain_total_investment", self.mock_load_chain_total_investment):
                result = self._consume_generator(
    ...
    def test_calculate_user_share_values_success(self):
        ...
        def mock_get_http_response(*args, **kwargs):
            ...
            mock_response.body = json.dumps({"data": {"service": {"blockNumber": "12345", "blockTimestamp": "1234567890", "currentOlasStaked": "1000", "id": "test", "olasRewardsEarned": "100"}}}).encode("utf-8")
            yield
    ...
    @pytest.mark.parametrize("position_type,position,chain,mock_user_share_value,mock_pool_name,expected_user_balances,expected_details,expected_token_info,expected_exception,test_description", [
        ...
        (
            ...
            "mode",
            {"0x1111111111111111111111111111111111111111": Decimal("1.5"), "0x2222222222222222222222222222222222222222": Decimal("2000")},
        ...
        (
            ...
            "optimism",
            {"0x1111111111111111111111111111111111111111": Decimal("2.0"), "0x2222222222222222222222222222222222222222": Decimal("3000")},
        ...
        (
            ...
            "optimism",
            {"0x6666666666666666666666666666666666666666": Decimal("1.0"), "0x7777777777777777777777777777777777777777": Decimal("1500")},
        ...
        (
            ...
            "optimism",
            {"0x6666666666666666666666666666666666666666": Decimal("0.5"), "0x7777777777777777777777777777777777777777": Decimal("750")},
            None,  # Velodrome doesn't use pool name
            {"0x6666666666666666666666666666666666666666": Decimal("0.5"), "0x7777777777777777777777777777777777777777": Decimal("750")},
            "Velodrome Pool",
            {
    ...
    def test_handle_position_variations(self, position_type, position, chain, mock_user_share_value, mock_pool_name, expected_user_balances, expected_details, expected_token_info, expected_exception, test_description):
        ...
        if position_type == "balancer":
            ...
            with patch.multiple(
                ...
                with patch.dict(fetch_behaviour.params.safe_contract_addresses, safe_addresses, clear=False):
                    if expected_exception:
                        ...
                        assert user_balances == expected_user_balances, f"Expected {expected_user_balances} for {test_description}"
                        assert details == expected_details, f"Expected {expected_details} for {test_description}"
                        assert token_info == expected_token_info, f"Expected {expected_token_info} for {test_description}"
    ...
    @pytest.mark.parametrize("position,chain,user_balances,token_info,portfolio_breakdown,mock_price_responses,expected_result,expected_breakdown_length,expected_breakdown_assets,test_description", [
    ...
    def test_calculate_position_value_variations(self, position, chain, user_balances, token_info, portfolio_breakdown, mock_price_responses, expected_result, expected_breakdown_length, expected_breakdown_assets, test_description):
        ...
        with patch.object(fetch_behaviour, '_fetch_token_price', mock_fetch_token_price):
            ...
            assert len(portfolio_breakdown) == expected_breakdown_length, f"Expected {expected_breakdown_length} breakdown entries for {test_description}"
            
            # Verify breakdown assets if any
            if expected_breakdown_assets:
                actual_assets = [entry["asset"] for entry in portfolio_breakdown]
                assert actual_assets == expected_breakdown_assets, f"Expected assets {expected_breakdown_assets} for {test_description}"
    ...
    def test_update_position_with_current_value_cost_recovered(self):
        ...
        def mock_calculate_corrected_yield(position, initial_amount0, initial_amount1, user_balances, chain, token_prices):
            yield
        ...
        with patch.object(fetch_behaviour, '_get_current_timestamp', mock_get_current_timestamp):
            with patch.object(fetch_behaviour, '_get_current_token_balances', mock_get_current_token_balances):
                with patch.object(fetch_behaviour, '_calculate_corrected_yield', mock_calculate_corrected_yield):
                    # Consume the generator
                    list(fetch_behaviour._update_position_with_current_value(position, current_value_usd, "mode"))
    ...
    @pytest.mark.parametrize("eth_transfers,reversion_transfers,mock_price_response,expected_result,test_description", [
    ...
    def test_calculate_total_reversion_value_variations(self, eth_transfers, reversion_transfers, mock_price_response, expected_result, test_description):
    ...
    @pytest.mark.parametrize("contract_result,expected_result,test_description", [
        ("Sturdy Aggregator V1", "Sturdy Aggregator V1", "successful contract call"),
        (None, None, "contract call failure"),
    ])
    def test_get_aggregator_name_variations(self, contract_result, expected_result, test_description):
    ...
    @pytest.mark.parametrize("contract_result,expected_result,test_description", [
        ("Balancer Pool USDC-ETH", "Balancer Pool USDC-ETH", "successful contract call"),
        (None, None, "contract call failure"),
    ])
    def test_get_balancer_pool_name_variations(self, contract_result, expected_result, test_description):
    ...
    @pytest.mark.parametrize("contract_result,expected_result,test_description", [
        (["0x1111111111111111111111111111111111111111", "0x2222222222222222222222222222222222222222"], True, "valid safe with owners"),
        (None, False, "not a GnosisSafe"),
        ("exception", False, "contract interaction exception"),
    ])
    def test_check_is_valid_safe_address_variations(self, contract_result, expected_result, test_description):
    ...
    def test_get_token_decimals_variations(self, contract_result, expected_result, test_description):
    ...
    def test_get_token_symbol_variations(self, contract_result, expected_result, test_description):
    ...
    def test_get_token_name_variations(self, contract_result, expected_result, test_description):
    ...
    @pytest.mark.parametrize("chain,expected_result,test_description", [
        ("mode", "0xd988097fb8612cc24eeC14542bC03424c656005f", "mode chain"),
        ("optimism", "0x0b2C639c533813f4Aa9D7837CAf62653d097Ff85", "optimism chain"),
        ("unknown", None, "unknown chain"),
    ])
    def test_get_usdc_address_variations(self, chain, expected_result, test_description):
    ...
    @pytest.mark.parametrize("chain,expected_result,test_description", [
        ...
        ("optimism", "0xfc2e6e6bcbd49ccf3a5f029c79984372dcbfe527", "optimism chain"),
        ("unknown", None, "unknown chain"),
    ])
    def test_get_olas_address_variations(self, chain, expected_result, test_description):
    ...
    @pytest.mark.parametrize("safe_address,chain,mock_incoming_transfers,mock_outgoing_transfers,mock_master_address,mock_native_balance,mock_reversion_value,expected_result,test_description", [
    ...
    def test_track_eth_transfers_and_reversions_variations(self, safe_address, chain, mock_incoming_transfers, mock_outgoing_transfers, mock_master_address, mock_native_balance, mock_reversion_value, expected_result, test_description):
        ...
        if "invalid timestamp handling" in test_description:
            ...
            with patch('packages.valory.skills.liquidity_trader_abci.behaviours.fetch_strategies.datetime', MockDateTime):
                with patch.multiple(
                    fetch_behaviour,
                    ...
                    result = self._consume_generator(
                        fetch_behaviour._track_eth_transfers_and_reversions(safe_address, chain)
                    )
    ...
    @pytest.mark.parametrize("kv_response,expected_result,test_description", [
    ...
    def test_read_investing_paused_variations(self, kv_response, expected_result, test_description):
    ...
    def test_calculate_initial_investment_value_success(self):
        ...
        with patch.object(fetch_behaviour, '_fetch_all_transfers_until_date_mode', mock_fetch_all_transfers_until_date_mode), \
            ...
            patch.object(fetch_behaviour, '_read_kv', self.mock_read_kv_empty), \
            patch.object(fetch_behaviour, '_load_chain_total_investment', self.mock_load_chain_total_investment), \
    ...
    def test_calculate_chain_investment_value_negative_amounts(self):
        ...
        with patch.object(fetch_behaviour, '_track_eth_transfers_and_reversions', self.mock_track_eth_transfers_and_reversions_zero_reversion), \
            patch.object(fetch_behaviour, '_fetch_historical_eth_price', mock_fetch_historical_eth_price), \
            patch.object(fetch_behaviour, '_save_chain_total_investment', self.mock_save_chain_total_investment):
        ...
        with patch.dict('os.environ', {'AEA_AGENT': 'test:agent:hash'}):
            ...
            with patch.object(fetch_behaviour, '_get_current_timestamp', return_value=1234567890):
                result = fetch_behaviour._create_portfolio_data(
                    total_pools_value, total_safe_value, Decimal('0.0'), initial_investment, 
    ...
    def test_create_portfolio_data_zero_initial_investment(self):
        ...
        with patch.dict('os.environ', {'AEA_AGENT': 'test:agent:hash'}):
            with patch.object(fetch_behaviour, '_get_current_timestamp', return_value=1234567890):
                result = fetch_behaviour._create_portfolio_data(
                    Decimal('1000.0'), Decimal('500.0'), Decimal('0.0'), 0.0,
                    500.0, [], []
                )
    ...
    def test_create_portfolio_data_negative_initial_investment(self):
        ...
        with patch.dict('os.environ', {'AEA_AGENT': 'test:agent:hash'}):
            with patch.object(fetch_behaviour, '_get_current_timestamp', return_value=1234567890):
                result = fetch_behaviour._create_portfolio_data(
                    Decimal('1000.0'), Decimal('500.0'), Decimal('0.0'), -100.0, 
                    500.0, [], []
                )
    ...
    def test_create_portfolio_data_no_agent_config(self):
        ...
        with patch.dict('os.environ', {}, clear=True):
            with patch.object(fetch_behaviour, '_get_current_timestamp', return_value=1234567890):
                result = fetch_behaviour._create_portfolio_data(
                    Decimal('1000.0'), Decimal('500.0'), Decimal('0.0'), 1000.0, 
                    500.0, [], []
                )
    ...
    def test_period_0_initialization_logic(self):
        ...
        def mock_check_and_update_zero_liquidity_positions_impl():
            ...
            fetch_behaviour.context.logger.info("Zero liquidity positions checked and updated")
    ...
    def test_period_0_validation_methods(self):
        ...
        with patch.object(fetch_behaviour, 'update_position_amounts', mock_update_position_amounts):
        ...
        with patch.object(fetch_behaviour, 'check_and_update_zero_liquidity_positions', mock_check_and_update_zero_liquidity_positions):
    ...
    def test_calculate_corrected_yield_basic_case(self):
        ...
        current_balances = {
            "0xA0b86a33E6416c69C88bb798B7e8d1c7B3B5f9C8": Decimal("1010.0"),  # 1010 USDC
    ...
    def test_calculate_corrected_yield_with_provided_prices(self):
        ...
        current_balances = {
            "0xA0b86a33E6416c69C88bb798B7e8d1c7B3B5f9C8": Decimal("2025.0"),  # 2025 USDC
        ...
        token_prices = {
            ...
            "0x4200000000000000000000000000000000000006": Decimal("3000.0"),  # WETH price
        }
        ...
        with patch.object(fetch_behaviour, '_get_token_decimals', mock_get_token_decimals):
            result = self._consume_generator(fetch_behaviour._calculate_corrected_yield(
                position, initial_amount0, initial_amount1, current_balances, "optimism", token_prices
            ))
    ...
    def test_calculate_corrected_yield_with_velo_rewards(self):
        ...
        current_balances = {
            "0xA0b86a33E6416c69C88bb798B7e8d1c7B3B5f9C8": Decimal("1005.0"),  # 1005 USDC
    ...
    def test_calculate_corrected_yield_no_token_increases(self):
        ...
        current_balances = {
            "0xA0b86a33E6416c69C88bb798B7e8d1c7B3B5f9C8": Decimal("1000.0"),  # Same as initial
            "0x4200000000000000000000000000000000000006": Decimal("0.5"),  # Same as initial
        }
    ...
    def test_get_user_share_value_velodrome_cl_pool(self):
        ...
        def mock_get_user_share_value_velodrome_cl(pool_address, chain, position, token0_address, token1_address):
            """Mock _get_user_share_value_velodrome_cl method."""
            yield
            return expected_result

        with patch.object(fetch_behaviour, '_get_user_share_value_velodrome_cl', mock_get_user_share_value_velodrome_cl):
            result = self._consume_generator(fetch_behaviour.get_user_share_value_velodrome(
                user_address, pool_address, token_id, chain, position
            ))

            assert result == expected_result

    @pytest.mark.parametrize("is_cl_pool,test_description", [
        (False, "explicit is_cl_pool=False"),
        (None, "is_cl_pool not specified (defaults to False)"),
    ])
    def test_get_user_share_value_velodrome_non_cl_pool_variations(self, is_cl_pool, test_description):
        ...
        def mock_get_user_share_value_velodrome_non_cl(user_address, pool_address, chain, position, token0_address, token1_address):
            """Mock _get_user_share_value_velodrome_non_cl method."""
            yield
            return expected_result

        with patch.object(fetch_behaviour, '_get_user_share_value_velodrome_non_cl', mock_get_user_share_value_velodrome_non_cl):
            result = self._consume_generator(fetch_behaviour.get_user_share_value_velodrome(
                user_address, pool_address, token_id, chain, position
            ))
    ...
    @pytest.mark.parametrize("token0_address,token1_address,test_description", [
        (None, "0x4200000000000000000000000000000000000006", "missing token0 address"),
        ("0xA0b86a33E6416c69C88bb798B7e8d1c7B3B5f9C8", None, "missing token1 address"),
    ...
    def test_get_user_share_value_velodrome_invalid_token_addresses(self, token0_address, token1_address, test_description):
    ...
    def test_fetch_token_transfers_mode_variations(self, api_response, expected_result, test_description):
        ...
        with patch('requests.get', mock_requests_get):
            ...
            assert result is expected_result, f"Expected {expected_result} for {test_description}"
    ...
    def test_fetch_eth_transfers_mode_variations(self, api_response, expected_result, test_description):
    ...
    @pytest.mark.parametrize("address,current_date,mock_api_response,expected_result,test_description", [
    ...
    def test_fetch_outgoing_transfers_until_date_optimism_variations(self, address, current_date, mock_api_response, expected_result, test_description):
        ...
        if address:  # Only mock the API call if we have an address
            with patch.object(fetch_behaviour, '_request_with_retries', mock_request_with_retries):
                result = self._consume_generator(fetch_behaviour._fetch_outgoing_transfers_until_date_optimism(address, current_date))
        else:  # No address case doesn't make API calls
            result = self._consume_generator(fetch_behaviour._fetch_outgoing_transfers_until_date_optimism(address, current_date))
        
        assert result == expected_result, f"Expected {expected_result} for {test_description}"

    @pytest.mark.parametrize("safe_address,current_date,mock_requests_response,expected_behavior,test_description", [
    ...
    def test_track_eth_transfers_mode_variations(self, safe_address, current_date, mock_requests_response, expected_behavior, test_description):
    ...
    def test_get_user_share_value_balancer_success(self):
        ...
        with patch.object(fetch_behaviour, 'contract_interact', mock_contract_interact), \
            ...
            result = self._consume_generator(fetch_behaviour.get_user_share_value_balancer(user_address, pool_id, pool_address, chain))
    ...
    def test_get_user_share_value_sturdy_success(self):
        ...
        with patch.object(fetch_behaviour, 'contract_interact', mock_contract_interact):
            ...
            result = self._consume_generator(fetch_behaviour.get_user_share_value_sturdy(user_address, aggregator_address, asset_address, chain))
    ...
    @pytest.mark.parametrize("test_whitelisted_assets,price_behavior,expected_removals,expected_remaining,test_description", [
        ...
        (
            ...
            ["0xdfc7c877a950e49d2610114102175a06c2e3167a"],  # MODE should be removed
        ...
        (
            ...
            [],  # no removals
            ["0x4200000000000000000000000000000000000006", "0xdfc7c877a950e49d2610114102175a06c2e3167a"],  # both remain
            "no price drops"
        ),
    ...
    def test_track_whitelisted_assets_variations(self, test_whitelisted_assets, price_behavior, expected_removals, expected_remaining, test_description):
                ...
                for token_address in expected_removals:
                    for chain in fetch_behaviour.whitelisted_assets:
                        if token_address in fetch_behaviour.whitelisted_assets[chain]:
                            assert token_address not in fetch_behaviour.whitelisted_assets[chain], \
                ...
                for token_address in expected_remaining:
                    ...
                    for chain in fetch_behaviour.whitelisted_assets:
                        if token_address in fetch_behaviour.whitelisted_assets[chain]:
                            found = True
                            break
                    assert found, f"Token {token_address} should remain for {test_description}"

    @pytest.mark.parametrize("from_address,tx_data,is_eth_transfer,mock_is_gnosis_safe,expected_result,test_description", [
    ...
    def test_should_include_transfer_mode_variations(self, from_address, tx_data, is_eth_transfer, mock_is_gnosis_safe, expected_result, test_description):
        """Test _should_include_transfer_mode method with various scenarios."""
        fetch_behaviour = self._create_fetch_strategies_behaviour()
        
        if mock_is_gnosis_safe is not None:
            with patch.object(fetch_behaviour, '_is_gnosis_safe', return_value=mock_is_gnosis_safe):
                result = fetch_behaviour._should_include_transfer_mode(from_address, tx_data, is_eth_transfer)
        else:
            result = fetch_behaviour._should_include_transfer_mode(from_address, tx_data, is_eth_transfer)
        
        assert result is expected_result, f"Expected {expected_result} for {test_description}"

    @pytest.mark.parametrize("from_address,mock_kv_response,mock_optimism_rpc_response,mock_safe_api_response,expected_result,test_description", [
        ...
        (
            "0x1234567890123456789012345678901234567890",
            {"contract_check_optimism_0x1234567890123456789012345678901234567890": '{"is_eoa": true}'},  # Cache hit
    ...
    def test_should_include_transfer_optimism_variations(self, from_address, mock_kv_response, mock_optimism_rpc_response, mock_safe_api_response, expected_result, test_description):
        ...
        with patch.multiple(
            ...
            result = self._consume_generator(fetch_behaviour._should_include_transfer_optimism(from_address))
            assert result is expected_result, f"Expected {expected_result} for {test_description}"

    @pytest.mark.parametrize("pool_address,token_id,chain,position,mock_position_manager_address,mock_slot0_data,mock_position_details,mock_token_decimals,expected_result,test_description", [
        ...
        (
            ...
            {
                "0x4200000000000000000000000000000000000006": Decimal("0.100000000000000001"),  # token0 balance
                "0xdfc7c877a950e49d2610114102175a06c2e3167a": Decimal("0.200000000000000001")   # token1 balance
            },
        ...
        (
            ...
            "0x9876543210987654321098765432109876543210",
            {
                "sqrt_price_x96": None,  # Invalid data
                "tick": 1000
            },
            None,
            None,
    ...
    def test_get_user_share_value_uniswap_variations(self, pool_address, token_id, chain, position, mock_position_manager_address, mock_slot0_data, mock_position_details, mock_token_decimals, expected_result, test_description):
        ...
        with patch.multiple(
            ...
            result = self._consume_generator(fetch_behaviour.get_user_share_value_uniswap(pool_address, token_id, chain, position))
            assert result == expected_result, f"Expected {expected_result} for {test_description}"
    ...
    @pytest.mark.parametrize("accumulated_rewards,olas_price,expected_result,test_description", [
    ...
    def test_calculate_stakig_rewards_value_variations(self, accumulated_rewards, olas_price, expected_result, test_description):
        ...
        with patch.multiple(
            ...
            result = self._consume_generator(fetch_behaviour.calculate_stakig_rewards_value())
            assert result == expected_result, f"Expected {expected_result} for {test_description}"
    ...
    @pytest.mark.parametrize("dex_type,is_cl_pool,current_liquidity,positions,expected_status,test_description", [
    ...
    def test_check_and_update_zero_liquidity_positions_variations(self, dex_type, is_cl_pool, current_liquidity, positions, expected_status, test_description):
        ...
        with patch.multiple(
            ...
            assert fetch_behaviour.current_positions[0]["status"] == expected_status, f"Expected {expected_status} for {test_description}"

    @pytest.mark.parametrize("current_positions,expected_calls,expected_logs,test_description", [
        ...
        (
            [
                {"status": "closed", "dex_type": "balancerPool", "chain": "mode"},
                {"status": "open", "dex_type": "balancerPool", "chain": "mode", "pool_address": "0x123"},
                {"status": "open", "dex_type": "UniswapV3", "chain": "optimism", "token_id": 123}
            ],
            ["_update_balancer_position", "_update_uniswap_position"],
            ["Updating position of type balancerPool on chain mode", "Updating position of type UniswapV3 on chain optimism"],
        ...
        (
            [
                {"status": "open", "dex_type": "balancerPool", "chain": "mode", "pool_address": "0x123"},
                {"status": "open", "dex_type": "UniswapV3", "chain": "optimism", "token_id": 123},
                {"status": "open", "dex_type": "velodrome", "chain": "optimism", "is_cl_pool": False, "pool_address": "0x456"},
                {"status": "open", "dex_type": "Sturdy", "chain": "mode", "pool_address": "0x789"}
            ],
            ["_update_balancer_position", "_update_uniswap_position", "_update_velodrome_position", "_update_sturdy_position"],
            [
    ...
    def test_update_position_amounts_variations(self, current_positions, expected_calls, expected_logs, test_description):
        ...
        with patch.multiple(
            ...
            assert mock_calls == expected_calls, f"Expected calls {expected_calls} for {test_description}, got {mock_calls}"
    ...
    def test_update_position_amounts_balancer_success(self):
        ...
        fetch_behaviour.params.__dict__["_frozen"] = False
        fetch_behaviour.params.safe_contract_addresses = {"mode": "0x9876543210987654321098765432109876543210"}
        fetch_behaviour.params.__dict__["_frozen"] = True
        ...
        with patch.multiple(
            ...
            assert fetch_behaviour.current_positions[0]["current_liquidity"] == 1000000000000000000
    ...
    def test_update_position_amounts_uniswap_success(self):
        ...
        with patch.multiple(
            ...
            # Verify the position was updated correctly
            assert fetch_behaviour.current_positions[0]["current_liquidity"] == 500000000000000000
    ...
    def test_update_position_amounts_velodrome_success(self):
        ...
        # Temporarily unfreeze params to set safe contract addresses
        fetch_behaviour.params.__dict__["_frozen"] = False
        fetch_behaviour.params.safe_contract_addresses = {"optimism": "0x9876543210987654321098765432109876543210"}
        fetch_behaviour.params.__dict__["_frozen"] = True
        ...
        with patch.multiple(
            ...
            # Verify the position was updated correctly
            assert fetch_behaviour.current_positions[0]["current_liquidity"] == 2000000000000000000
    ...
    def test_update_position_amounts_sturdy_success(self):
        ...
        with patch.multiple(
            ...
            # Verify the position was updated correctly
            assert fetch_behaviour.current_positions[0]["current_liquidity"] == 3000000000000000000
    ...
    def test_update_position_amounts_velodrome_cl_positions(self):
        ...
        with patch.multiple(
            ...
            assert fetch_behaviour.current_positions[0]["positions"][0]["current_liquidity"] == 1000000000000000000
            assert fetch_behaviour.current_positions[0]["positions"][1]["current_liquidity"] == 2000000000000000000
    ...
    def test_update_position_amounts_missing_parameters(self):
        ...
        test_cases = [
            ...
            {
                "position": {"status": "open", "dex_type": "balancerPool", "chain": "mode"},  # Missing pool_address
                "expected_log": "Missing required parameters for Balancer position"
            },
            # Uniswap missing parameters
            {
                "position": {"status": "open", "dex_type": "UniswapV3", "chain": "optimism"},  # Missing token_id
            ...
            {
                "position": {"status": "open", "dex_type": "velodrome", "chain": "optimism", "is_cl_pool": False},  # Missing pool_address
                "expected_log": "Missing required parameters for Velodrome pool position"
            },
            # Sturdy missing parameters
            {
                "position": {"status": "open", "dex_type": "Sturdy", "chain": "mode"},  # Missing pool_address
        ...
        with patch.multiple(
            ...
            for test_case in test_cases:
                ...
                assert "current_liquidity" not in fetch_behaviour.current_positions[0], f"Should not have current_liquidity for {test_case['expected_log']}"
    ...
    @pytest.mark.parametrize("address,end_date,fetch_till_date,mock_funding_events,mock_token_transfers_success,mock_eth_transfers_success,mock_token_transfers_data,mock_eth_transfers_data,expected_result,expected_logs,test_description", [
        ...
        (
            ...
            "2024-01-15",
            False,
            {"optimism": {"2024-01-10": [{"type": "token", "amount": 100}]}},  # No mode data
            True,
            True,
            {"2024-01-12": [{"type": "token", "amount": 200}]},
            {"2024-01-13": [{"type": "eth", "amount": 1.5, "delta": 1.5}]},
    ...
    def test_fetch_all_transfers_until_date_mode_variations(self, address, end_date, fetch_till_date, mock_funding_events, mock_token_transfers_success, mock_eth_transfers_success, mock_token_transfers_data, mock_eth_transfers_data, expected_result, expected_logs, test_description):
        ...
        def mock_fetch_token_transfers_mode(address, end_datetime, all_transfers_by_date, fetch_till_date):
        ...
        def mock_fetch_eth_transfers_mode(address, end_datetime, all_transfers_by_date, fetch_till_date):
    ...
    def test_fetch_all_transfers_until_date_mode_backward_compatibility_multiple_dates(self):
        ...
        mock_funding_events = {
            "mode": {
                ...
                "2024-01-12": [
                    {"type": "eth", "amount": 3.0}  # Missing delta
                ]
            }
        }
        ...
        def mock_fetch_token_transfers_mode(address, end_datetime, all_transfers_by_date, fetch_till_date):
            ...
            all_transfers_by_date.update({"2024-01-15": [{"type": "token", "amount": 300}]})
            return True
        
        def mock_fetch_eth_transfers_mode(address, end_datetime, all_transfers_by_date, fetch_till_date):
            # Should be called with fetch_till_date=True due to backward compatibility
            assert fetch_till_date is True
            all_transfers_by_date.update({"2024-01-16": [{"type": "eth", "amount": 4.0, "delta": 4.0}]})
            return True
    ...
    @pytest.mark.parametrize("address,end_date,mock_funding_events,mock_optimism_transfers_data,mock_optimism_transfers_success,expected_result,expected_logs,test_description", [
        # Test 1: Successful fetch with new data
        (
            "0x1234567890123456789012345678901234567890",
            "2024-01-15",
            {"optimism": {"2024-01-10": [{"type": "token", "amount": 100}]}},
            {"2024-01-12": [{"type": "token", "amount": 200}], "2024-01-13": [{"type": "eth", "amount": 1.5}]},
        ...
        (
            "0x1234567890123456789012345678901234567890",
            "2024-01-15",
            {"mode": {"2024-01-10": [{"type": "token", "amount": 100}]}},  # No optimism data
            {"2024-01-12": [{"type": "token", "amount": 200}]},
            True,
            {
                "2024-01-12": [{"type": "token", "amount": 200}]
    ...
    def test_fetch_all_transfers_until_date_optimism_variations(self, address, end_date, mock_funding_events, mock_optimism_transfers_data, mock_optimism_transfers_success, expected_result, expected_logs, test_description):
        ...
        def mock_fetch_optimism_transfers_safeglobal(address, end_date, all_transfers_by_date, existing_optimism_data):
        ...
        with patch.multiple(
            ...
            result = self._consume_generator(fetch_behaviour._fetch_all_transfers_until_date_optimism(
                address, end_date
            ))
    ...
    def test_fetch_all_transfers_until_date_optimism_generator_behavior(self):
        ...
        mock_funding_events = {"optimism": {"2024-01-10": [{"type": "token", "amount": 100}]}}
    ...
    def test_fetch_all_transfers_until_date_optimism_no_duplicate_dates(self):
        ...
        existing_data = {"optimism": {"2024-01-12": [{"type": "token", "amount": 100, "existing": True}]}}
        # New data also has 2024-01-12 (should not overwrite) and 2024-01-13 (should be added)
        new_transfer_data = {
            "2024-01-12": [{"type": "token", "amount": 200, "new": True}],  # Should not overwrite
        ...
        with patch.multiple(
            ...
            expected_stored_data = {
                "optimism": {
                    "2024-01-12": [{"type": "token", "amount": 100, "existing": True}],  # Original preserved
    ...
    def test_fetch_token_transfers_basic(self):
        ...
        with patch.multiple(
            ...
            result = self._consume_generator(fetch_behaviour._fetch_token_transfers(
                "0x1234567890123456789012345678901234567890",
                datetime(2024, 1, 15),
    ...
    @pytest.mark.parametrize("address,end_datetime,mock_api_response,mock_should_include_transfer_results,existing_data,expected_transfers,test_description", [
        ...
        (
            ...
            (True, {
                "items": [
                    {
                        "timestamp": "2024-01-10T10:30:00Z",
                        "from": {"hash": "0x0000000000000000000000000000000000000000"},  # Null address
                        "token": {
                            "symbol": "USDC",
                            "address": "0x1234567890123456789012345678901234567890",
                            "decimals": 6
    ...
    def test_fetch_token_transfers_variations(self, address, end_datetime, mock_api_response, mock_should_include_transfer_results, existing_data, expected_transfers, test_description):
        ...
        def mock_should_include_transfer(from_address, tx, is_eth_transfer):
            ...
            if len(should_include_calls) <= len(mock_should_include_transfer_results):
                return mock_should_include_transfer_results[len(should_include_calls) - 1]
            return True  # Default
        ...
        with patch.multiple(
            ...
            assert actual_transfers == expected_transfers, f"Expected {expected_transfers} for {test_description}, got {actual_transfers}"
    ...
    def test_fetch_token_transfers_date_filtering(self):
        ...
        from collections import defaultdict
        all_transfers_by_date = defaultdict(list)
        existing_data = {"2024-01-10": [{"type": "existing"}]}  # Existing data for 2024-01-10
        ...
        for i, test_case in enumerate(test_cases):
            mock_response = (True, {
                "items": [
                    {
                        "timestamp": "2024-01-10T10:30:00Z",
                        "from": {"hash": f"0x{i}234567890123456789012345678901234567890"},
                        "token": {
                            "symbol": f"TOKEN{i}",
            ...
            with patch.multiple(
                ...
                assert actual_transfers["2024-01-10"][0]["amount"] == test_case["expected_amount"]
    ...
    def test_fetch_token_transfers_missing_fields(self):
        ...
        with patch.multiple(
            ...
            assert transfer_12["from_address"] == "0x5555555555555555555555555555555555555555"
    ...
    def test_fetch_optimism_transfers_safeglobal_basic(self):
        ...
        with patch.multiple(
            ...
            result = list(fetch_behaviour._fetch_optimism_transfers_safeglobal(
                "0x9876543210987654321098765432109876543210",
                "2024-01-15",
                all_transfers_by_date,
                existing_data
    ...
    @pytest.mark.parametrize("address,end_date,mock_api_response,mock_should_include_results,existing_data,expected_transfers,expected_logs,test_description", [
        ...
        (
            ...
            ["Fetching Optimism transfers using SafeGlobal API...", "Completed Optimism transfers: 1 found"],
        ...
        (
            ...
            {},
            {},
            ["Fetching Optimism transfers using SafeGlobal API...", "Failed to fetch Optimism transfers"],
            "API request fails"
        ),
        ...
        (
            ...
            {},
            {},
            ["Fetching Optimism transfers using SafeGlobal API...", "Completed Optimism transfers: 0 found"],
            "no transfers returned"
        ),
        ...
        (
            ...
            ["Fetching Optimism transfers using SafeGlobal API...", "Completed Optimism transfers: 2 found"],
            "pagination with multiple pages"
        ),
    ])
    def test_fetch_optimism_transfers_safeglobal_variations(self, address, end_date, mock_api_response, mock_should_include_results, existing_data, expected_transfers, expected_logs, test_description):
    ...
    def test_fetch_optimism_transfers_safeglobal_missing_fields(self):
        ...
        assert transfer_2["from_address"] == "0x1234567890123456789012345678901234567890"
        assert transfer_2["amount"] == 0.0  # Missing value defaults to 0

    @pytest.mark.parametrize("position,chain,user_address,mock_pool,mock_gauge_address,mock_pending_rewards,expected_result,expected_logs,test_description", [
        ...
        (
            ...
            "mock_pool",
            "0x5555555555555555555555555555555555555555",
            [1000000000000000000, None, 3000000000000000000],  # 1 VELO, None, 3 VELO
    ...
    def test_get_velodrome_pending_rewards_variations(self, position, chain, user_address, mock_pool, mock_gauge_address, mock_pending_rewards, expected_result, expected_logs, test_description):
            ...
            if position.get("is_cl_pool", False) and mock_gauge_address:
                ...
                def mock_get_cl_pending_rewards(self, account, gauge_address, chain, token_id):
                    ...
                    try:
                        ...
                        return mock_pending_rewards[index] if index < len(mock_pending_rewards) else 0
                    except ValueError:
                        return 0
        ...
        result = self._consume_generator(
            fetch_behaviour._get_velodrome_pending_rewards(position, chain, user_address)
        )
    ...
    def test_get_velodrome_pending_rewards_exception_handling(self):
        ...
        result = self._consume_generator(
            fetch_behaviour._get_velodrome_pending_rewards(position, "optimism", "0xuser")
        )
    ...
    def test_get_velodrome_pending_rewards_generator_behavior(self):
        ...
        # Verify it's a generator
        generator = fetch_behaviour._get_velodrome_pending_rewards(position, "optimism", "0xuser")
    ...
    @pytest.mark.parametrize("position,mock_response,expected_result,test_description", [
    ...
    def test_validate_velodrome_v2_pool_address_variations(self, position, mock_response, expected_result, test_description):
        ...
        with patch.multiple(
            fetch_behaviour,
            get_transaction_receipt=mock_get_transaction_receipt
        ):
            result = self._consume_generator(
            ...
            if expected_result and "addresses differ" in test_description:
                assert position["is_updated"] == True, "Position should be marked as updated"
                assert position["pool_address"] == "0xabcdefabcdefabcdefabcdefabcdefabcdefabcd", "Pool address should be updated"
    ...
    def test_validate_velodrome_v2_pool_address_multiple_logs(self):
        ...
        with patch.multiple(
            ...
            assert position["is_updated"] == True, "Position should be marked as updated"
            assert position["pool_address"] == "0xabcdefabcdefabcdefabcdefabcdefabcdefabcd", "Pool address should be updated to second log address"
    ...
    def test_validate_velodrome_v2_pool_address_missing_address_field(self):
        ...
        with patch.multiple(
            ...
            assert result == False, "Should return False when log is missing address field"
