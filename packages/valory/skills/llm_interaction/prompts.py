...
2. The JSON should have the following keys:
   ...
   - 'reasoning': A brief explanation of why the selected trading type and protocols was chosen, based on the user's risk appetite and what threshold we've chosen and what it means.
